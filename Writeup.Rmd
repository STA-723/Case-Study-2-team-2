...
We noticed several pieces of insight. In general, listings with a higher average length (in characters) were more expensive and popular. Furthermore, listings with (1) more words, (2) more capital letters (by percentage), (3) more positive sentiment, and (4) more adjectives were less expensive but more popular. Listings with (1) more punctuation and (2) more proper nouns were more expensive, but not clearly any more or less popular. Finally, there was no clear impact on the amount of exclamations. See appendix for more detailed plots.
