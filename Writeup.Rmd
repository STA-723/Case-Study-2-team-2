...
abstract: "We analyze New York City Airbnb data from 2019. In Particular, we attempt to identify factors that significantly contribute to a listing's popularity and price. An exploratory data anlysis is done with plots and figures given in the appendix. YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE.YOU GUYS CAN WRITE A LITTLE BLURB ON YOUR STUFF HERE   "
output: 
  pdf_document:
    keep_tex: true
    fig_caption: true
...
We analyzed data from Airbnb, a platform that allows hosts to rent out their homes to short- and long-term guests. 48,895 listings from 2019 in New York City, NY (NYC) were analyzed, with features including (1) information about the host, including host ID, name, and number of listings the host owns; (2) listing name and ID; (3) information about the location of the listing, including the borough and neighborhood in NYC as well as longitude and latitude; (4) the room type; (5) minimum nights required to stay; (6) price; (7) information regarding the reviews left by guests, including number of reviews, date of last review, and average reviews per month; and (8) availability of the listing. Through this analysis, we seek to understand (1) influential factors on the price and popularity of listings, (2) if there exists heterogeneity among buroughs and/or neighborhoods (and, if so, which are the most expensive and popular), (3) whether room type availability varies across neighborhoods, and (4) how to name and where to locate a popular and expensive listing in NYC.
...
We analyzed various text features for listing names, including: (1) length, in characters and words, (2) percentage of listing that was capitalized, (3) amount of punctuation and exclamations, (4) positive sentiment using Python's NLTK package, and (5) number of adjectives and proper nouns. 

In order to better understand the relationship between each of these features on price and popularity, we sorted first on price into five quantiles and then into popularity, again into five quantile, for each price quantile, and determined the mean value for each feature in each of the 25 "buckets".

See appendix for more detailed plots. We noticed several pieces of insight, including, in general, (1) listings with a higher average length (in characters) were more expensive and popular, (2) listings with more words were less expensive but more popular, (3) listings with more punctuation were more expensive, (4) there was no clear impact of amount of exclamations, (5) listings with more capital letters (by percentage) were less expensive but more popular, (6) listings with more positive sentiment were less expensive but more popular, (7) listings with more adjectives were less expensive but more popular, and (8) listings with more proper nouns were more expensive.
