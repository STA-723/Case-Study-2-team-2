...
We placed $Gamma(.1,.1)$ priors on our precison parameters, and placed weakly informative normal priors on our coefficient/mean parameters. Also, we placed a uniform prior on $\rho$. Our final models can be represented as:
