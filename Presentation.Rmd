...
- # of punctuation, # of exclamations
- Sentiment analysis using Python's NLTK to determine positive sentiment
- # of adjectives, # of proper nouns

# Text Analysis

![Text analysis on length, # of words, # of punctuation, & # of exclamations.](plots/1.png)

# Text Analysis

![Text analysis on % capitalization, positive sentiment, # of adjectives, & # of proper nouns.](plots/2.png)
